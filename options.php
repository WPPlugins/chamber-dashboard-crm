...
if( !in_array( 'cdash-crm-importer.php', $plugins ) ) {
	...
	function cdcrm_import_promo() { ?>
		<p><?php _e( 'CRM Importer is now available! You can purchase this addon from the <a href="admin.php?page=chamber-dashboard-extensions">extensions</> page.', 'cdash-crm' ); ?></p>
	<?php }
}
